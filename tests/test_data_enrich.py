...
class DataEnrichmentTests(unittest.TestCase):
    def test_enricher_writes_company_snapshot_from_sec_and_prices(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(snapshots[0]["price_observations"], 2)
            self.assertEqual(snapshots[0]["latest_fundamental_as_of_time"], "2024-02-01T00:00:00Z")
