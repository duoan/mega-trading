...
""".strip()
    ...
    def test_checked_in_environment_ingest_configs_parse(self) -> None:
        ...
        self.assertEqual(mac.output_dir, ".mega-trading/mac")
        ...
        self.assertEqual(rtx.output_dir, ".mega-trading/rtx")
        self.assertEqual(rtx.raw_dir, ".mega-trading/raw")
        self.assertGreaterEqual(len(rtx.sources[0].tickers), 100)
        self.assertEqual(rtx.sources[0].download_workers, 16)
        self.assertEqual(rtx.sources[0].process_workers, 0)
        self.assertEqual(modal.output_dir, ".mega-trading/modal")
