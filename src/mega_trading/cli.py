...
def _run_train_config(config: DictConfig):
    ...
    train_config = TrainConfig(
        ...
        muon_momentum=float(config.training.muon_momentum),
        muon_ns_steps=int(config.training.muon_ns_steps),
        lr_schedule=str(config.training.lr_schedule),
        lr_warmup_steps=int(config.training.lr_warmup_steps),
        min_learning_rate=float(config.training.min_learning_rate),
        ...
        preload_numpy_arrays=bool(config.training.preload_numpy_arrays),
